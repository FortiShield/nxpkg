...
var NxpkgOrgWebhookURL = env.Get("SLACK_COMMENTS_BOT_HOOK", "", "Webhook for dogfooding notifications from an organization-level Slack bot.")

// Client is capable of posting a message to a Slack webhook
type Client struct {
	WebhookURL            string
	AlsoSendToNxpkg bool
}

// New creates a new Slack client
func New(webhookURL string, alsoSendToNxpkg bool) *Client {
	return &Client{WebhookURL: webhookURL, AlsoSendToNxpkg: alsoSendToNxpkg}
}
