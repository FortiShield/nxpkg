...
describe('repo/index', () => {
    ...
    describe('parseBrowserRepoURL', () => {
        it('should parse github repo', () => {
            const parsed = repo.parseBrowserRepoURL('https://nxpkg.com/github.com/gorilla/mux')
            assert.deepEqual(compact(parsed), {
                repoPath: 'github.com/gorilla/mux',
            })
        })
        it('should parse repo', () => {
            const parsed = repo.parseBrowserRepoURL('https://nxpkg.com/gorilla/mux')
            assert.deepEqual(compact(parsed), {
        ...
        it('should parse github repo with rev', () => {
            const parsed = repo.parseBrowserRepoURL('https://nxpkg.com/github.com/gorilla/mux@branch')
            assert.deepEqual(compact(parsed), {
                repoPath: 'github.com/gorilla/mux',
                rev: 'branch',
            })
        ...
        it('should parse repo with rev', () => {
            const parsed = repo.parseBrowserRepoURL('https://nxpkg.com/gorilla/mux@branch')
            assert.deepEqual(compact(parsed), {
                repoPath: 'gorilla/mux',
                rev: 'branch',
            })
        ...
        it('should parse github repo with multi-path-part rev', () => {
            const parsed = repo.parseBrowserRepoURL('https://nxpkg.com/github.com/gorilla/mux@foo/baz/bar')
            assert.deepEqual(compact(parsed), {
                repoPath: 'github.com/gorilla/mux',
                rev: 'foo/baz/bar',
            })
            const parsed2 = repo.parseBrowserRepoURL(
                'https://nxpkg.com/github.com/gorilla/mux@foo/baz/bar/-/blob/mux.go'
            )
        ...
        it('should parse repo with multi-path-part rev', () => {
            const parsed = repo.parseBrowserRepoURL('https://nxpkg.com/gorilla/mux@foo/baz/bar')
            assert.deepEqual(compact(parsed), {
                repoPath: 'gorilla/mux',
                rev: 'foo/baz/bar',
            })
            const parsed2 = repo.parseBrowserRepoURL('https://nxpkg.com/gorilla/mux@foo/baz/bar/-/blob/mux.go')
            assert.deepEqual(compact(parsed2), {
                repoPath: 'gorilla/mux',
                rev: 'foo/baz/bar',
                filePath: 'mux.go',
        ...
        it('should parse github repo with commitID', () => {
            const parsed = repo.parseBrowserRepoURL(
                'https://nxpkg.com/github.com/gorilla/mux@24fca303ac6da784b9e8269f724ddeb0b2eea5e7'
            )
            assert.deepEqual(compact(parsed), {
                repoPath: 'github.com/gorilla/mux',
                rev: '24fca303ac6da784b9e8269f724ddeb0b2eea5e7',
        ...
        it('should parse repo with commitID', () => {
            const parsed = repo.parseBrowserRepoURL(
                'https://nxpkg.com/gorilla/mux@24fca303ac6da784b9e8269f724ddeb0b2eea5e7'
            )
            assert.deepEqual(compact(parsed), {
                repoPath: 'gorilla/mux',
                rev: '24fca303ac6da784b9e8269f724ddeb0b2eea5e7',
        ...
        it('should parse github repo with rev and file', () => {
            const parsed = repo.parseBrowserRepoURL(
                'https://nxpkg.com/github.com/gorilla/mux@branch/-/blob/mux.go'
            )
            assert.deepEqual(compact(parsed), {
                repoPath: 'github.com/gorilla/mux',
                rev: 'branch',
        ...
        it('should parse repo with rev and file', () => {
            const parsed = repo.parseBrowserRepoURL('https://nxpkg.com/gorilla/mux@branch/-/blob/mux.go')
            assert.deepEqual(compact(parsed), {
                repoPath: 'gorilla/mux',
                rev: 'branch',
                filePath: 'mux.go',
        ...
        it('should parse github repo with rev and file and line', () => {
            const parsed = repo.parseBrowserRepoURL(
                'https://nxpkg.com/github.com/gorilla/mux@branch/-/blob/mux.go#L3'
            )
            assert.deepEqual(compact(parsed), {
                repoPath: 'github.com/gorilla/mux',
                rev: 'branch',
        ...
        it('should parse repo with rev and file and line', () => {
            const parsed = repo.parseBrowserRepoURL('https://nxpkg.com/gorilla/mux@branch/-/blob/mux.go#L3')
            assert.deepEqual(compact(parsed), {
                repoPath: 'gorilla/mux',
                rev: 'branch',
                filePath: 'mux.go',
        ...
        it('should parse github repo with rev and file and position', () => {
            const parsed = repo.parseBrowserRepoURL(
                'https://nxpkg.com/github.com/gorilla/mux@branch/-/blob/mux.go#L3:5'
            )
            assert.deepEqual(compact(parsed), {
                repoPath: 'github.com/gorilla/mux',
                rev: 'branch',
        ...
        it('should parse repo with rev and file and position', () => {
            const parsed = repo.parseBrowserRepoURL('https://nxpkg.com/gorilla/mux@branch/-/blob/mux.go#L3:5')
            assert.deepEqual(compact(parsed), {
                repoPath: 'gorilla/mux',
                rev: 'branch',
                filePath: 'mux.go',
