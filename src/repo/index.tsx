...
/**
 * Properties of a RepoURI (like git://github.com/gorilla/mux#mux.go) or a URL (like https://nxpkg.com/github.com/gorilla/mux/-/blob/mux.go)
 */
...
export function parseBrowserRepoURL(href: string): ParsedRepoURI {
    ...
    // - 'foo/bar' (from 'nxpkg.mycompany.com/foo/bar')
    // - 'foo/bar@revision' (from 'nxpkg.mycompany.com/foo/bar@revision')
    // - 'foobar' (from 'nxpkg.mycompany.com/foobar')
    // - 'foobar@revision' (from 'nxpkg.mycompany.com/foobar@revision')
    let repoRev: string
    if (indexOfSep === -1) {
