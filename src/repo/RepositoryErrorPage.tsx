                    ...
                    switchMap(([, { repo }]) =>
                        merge<Pick<State, 'addedOrError'>>(
                            ...
                            addRepository(repo).pipe(
                                ...
                                //
                                // See https://github.com/nxpkg/nxpkg/pull/9304.
                                delay(1500),
            ...
            <HeroPage
                ...
                subtitle={
                    <div className="repository-error-page">
                                ...
                                <div className="repository-error-page__section-inner">
                                    <div className="repository-error-page__section-description">
                                        ...
                                        {this.state.canAddOrError === true && (
                                            <>
                                                As a site admin, you can add this repository to Nxpkg to allow
                        ...
                        {!this.state.showAdd &&
                            !this.state.showEnable && <p>To access this repository, contact the Nxpkg admin.</p>}
                    </div>
                }
            />
        )
