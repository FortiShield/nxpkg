                        ...
                        <div className="alert alert-info repo-settings-mirror-page__troubleshooting">
                            ...
                            <ul className="repo-settings-mirror-page__steps">
                                ...
                                <li className="repo-settings-mirror-page__step">
                                    ...
                                    See{' '}
                                    <a href="https://about.nxpkg.com/docs/server/config/repositories#ssh-authentication-config-keys-known_hosts">
                                ...
                                <li className="repo-settings-mirror-page__step">
                                    Consult{' '}
                                    <a href="https://about.nxpkg.com/docs/server/config/repositories">
                                        Nxpkg repositories documentation
                                    </a>{' '}
