        ...
        return (
            <div className="repo-settings-options-page">
                ...
                <ActionContainer
                    ...
                    description="Permanently removes this repository and all associated data from Nxpkg. The original repository on the code host is not affected. If this repository was added by a configured code host, then it will be re-added during the next sync."
