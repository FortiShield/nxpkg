...
import { TextDocumentDecoration } from 'nxpkg/module/protocol/plainTypes'
...
export class Blob extends React.Component<BlobProps, BlobState> {
    ...
    constructor(props: BlobProps) {
        ...
        // Update the Nxpkg extensions environment to reflect the current file.
        this.subscriptions.add(
        ...
        // Clear the Nxpkg extensions environment's component when the blob is no longer shown.
