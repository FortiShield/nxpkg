...
const FIREFOX_EXTENSION_STORE_LINK = 'https://addons.mozilla.org/en-US/firefox/addon/nxpkg/'
    ...
    public render(): JSX.Element | null {
        ...
        return (
            <Toast
                ...
                title="Get Nxpkg on GitHub"
                subtitle={`Get code intelligence while browsing GitHub and reading PRs with the Nxpkg ${this.props.browserName
                    } extension`}
                cta={
                    <a
                        target="_blank"
