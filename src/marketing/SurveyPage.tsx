        ...
        return (
            <Form className="survey-form" onSubmit={this.handleSubmit}>
                ...
                <label className="survey-form__label">
                    How likely is it that you would recommend Nxpkg to a friend?
                </label>
                ...
                <div className="form-group">
                    <label className="survey-form__label">
                        What is the most important reason for the score you gave Nxpkg?
                    </label>
                    <textarea
                        className={`form-control survey-form__input`}
                ...
                <div className="form-group">
                    <label className="survey-form__label">What could Nxpkg do to provide a better product?</label>
                    <textarea
                        className={`form-control survey-form__input`}
                ...
                <div>
                    <small>
                        Your response to this survey will be sent to Nxpkg, and will be visible to your
                        Nxpkg site admins.
                    </small>
                </div>
            </Form>
