    ...
    public render(): JSX.Element | null {
        ...
        if (this.state.site && this.state.site.configuration && !this.state.site.configuration.canUpdate) {
            alerts.push(
                <div key="volatile" className="alert alert-danger site-admin-configuration-page__alert">
                    <p>
                        Use this editor as a scratch area for composing Nxpkg site configuration.{' '}
                    ...
                    <p>
                        <small>
                            ...
                            {formatEnvVar(this.state.site.configuration.source)} (in Nxpkg Server) or{' '}
                            <code>config.json</code> (in Nxpkg Data Center) with the configuration below and
                            restart the server. Online configuration editing is only supported for Nxpkg Server
        ...
        if (dataCenterProps.length > 0) {
            alerts.push(
                <div key="datacenter-props-present" className="alert alert-info site-admin-configuration-page__alert">
                    The configuration contains properties that are valid only in Nxpkg Data Center's{' '}
        ...
        return (
            <div className="site-admin-configuration-page">
                ...
                <p>
                    View and edit the Nxpkg site configuration. See{' '}
                    <a href="https://about.nxpkg.com/docs/server/">documentation</a> for more information.
                </p>
                        ...
                        <div>
                            ...
                            <p className="form-text text-muted">
                                <small>
                                    ...
                                    <a href="https://about.nxpkg.com/docs/server/config/settings">
                                        documentation
                                    </a>.
                                </small>
                            </p>
