    ...
    public render(): JSX.Element | null {
        ...
        return (
            <div className="site-admin-pings-page">
                ...
                <p>
                    Nxpkg periodically sends a ping to Nxpkg.com to help our product and customer teams. It
                    sends only the high-level data below. It never sends code, repository names, usernames, or any other
                    specific data.
                </p>
                <ul>
                    <li>Nxpkg version string</li>
                ...
                {!pingsEnabled ? (
                    ...
                    <p>
                        ...
                        <a href="https://about.nxpkg.com/contact/" target="_blank">
                            contact support
                        </a>.
                    </p>
                )}
