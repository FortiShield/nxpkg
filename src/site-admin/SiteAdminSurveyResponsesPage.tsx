                ...
                {(this.props.node.reason || this.props.node.better) && (
                    <dl className="mt-3">
                        {this.props.node.reason &&
                            this.props.node.reason !== '' && (
                                <>
                                    <dt>What is the most important reason for the score you gave Nxpkg?</dt>
                        ...
                        {this.props.node.better &&
                            this.props.node.better !== '' && (
                                <>
                                    <dt>What could Nxpkg do to provide a better product?</dt>
    ...
    public render(): JSX.Element | null {
        return (
            <div className="site-admin-survey-responses-page">
                ...
                <p>
                    After using Nxpkg for a few days, users are presented with a request to answer "How likely is
                    it that you would recommend Nxpkg to a friend?" on a scale from 0–10 and to provide some
                    feedback. Responses are visible below (and are also sent to Nxpkg).
                </p>
