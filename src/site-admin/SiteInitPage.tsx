...
/**
 * A page that is shown when the Nxpkg instance has not yet been initialized.
            ...
            <div className="site-init-page">
                <div className="site-init-page__content">
                    <img
                        ...
                        src={`${window.context.assetsRoot}/img/nxpkg-light-head-logo.svg`}
                    />
                    {this.props.user ? (
                        ...
                        <p>
                            ...
                            initialize Nxpkg before you can continue.
                        </p>
                    ) : (
                        <>
                            <h2 className="site-init-page__header">Welcome</h2>
                            <p>Create an admin account to start using Nxpkg.</p>
                            <SignUpForm
