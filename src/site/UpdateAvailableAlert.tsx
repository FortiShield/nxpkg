...
/**
 * A global alert telling the site admin that an updated version of the Nxpkg
...
export const UpdateAvailableAlert: React.SFC<{
    ...
    >
        ...
        <a className="site-alert__link" href="https://about.nxpkg.com" target="_blank" onClick={onClickCTA}>
            <span className="underline">Nxpkg {updateVersionAvailable}</span>
        </a>&nbsp;-&nbsp;
        <a
            className="site-alert__link"
            href="https://about.nxpkg.com/changelog"
            target="_blank"
