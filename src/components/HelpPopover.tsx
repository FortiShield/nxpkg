...
export class HelpPopover extends React.Component<Props> {
    private static LINKS: { title: string; description: string; template: string }[] = [
        ...
        { title: 'Feature request', description: 'Suggest an idea for Nxpkg', template: 'feature_request.md' },
        { title: 'Question', description: 'Ask a question about Nxpkg', template: 'question.md' },
    ]
            ...
            <div className="help-popover card" ref={this.setRef}>
                ...
                <div className="list-group list-group-flush">
                    <a
                        ...
                        href="https://about.nxpkg.com/docs/search/query-syntax"
                        target="_blank"
                    >
                    ...
                    <a
                        className="list-group-item list-group-item-action px-3 py-2"
                        href="https://about.nxpkg.com/docs"
                        target="_blank"
                    >
                        <BookOpenIcon className="icon-inline" /> Nxpkg documentation
                    </a>
                    <a
                        className="list-group-item list-group-item-action px-3 py-2"
                        href="https://github.com/nxpkg/issues/issues"
                        target="_blank"
                        rel="noreferrer"
                    >
                    ...
                    <a
                        className="list-group-item list-group-item-action px-3 py-2"
                        href="https://about.nxpkg.com/contact"
                        target="_blank"
                    >
                        <SquareEditOutlineIcon className="icon-inline" /> Contact Nxpkg
                    </a>
                </div>
                ...
                <div className="list-group list-group-flush">
                    {HelpPopover.LINKS.map(({ title, description, template }, i) => (
                        <Link
                            className="list-group-item list-group-item-action px-3 py-2"
                            key={i}
                            to={`https://github.com/nxpkg/issues/issues/new?template=${template}`}
                            target="_blank"
                            rel="noreferrer"
                        >
