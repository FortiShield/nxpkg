...
class TelligentWrapper {
    ...
    constructor() {
        // Never log anything in self-hosted Nxpkg instances.
    ...
    private initialize(siteID: string, env: string): void {
        ...
        const telligentUrl = 'nxpkg-logging.telligentdata.com'
        this.telligent('newTracker', 'sg', telligentUrl, {
             ...
             * on nxpkg.com subdomains (such as about.nxpkg.com). Subdomains should be removed
             * from the cookieDomain property to ensure analytics user profiles sync across all Nxpkg sites.
             */
