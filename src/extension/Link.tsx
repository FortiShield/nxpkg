...
/**
 * Returns the URL used to link the browser extension to a Nxpkg instance.
 *
...
/**
 * Embeds an iframe responsible for passing the current user and Nxpkg URL to the browser
 * extension.
 */
