...
/**
 * Does a GraphQL request to the Nxpkg GraphQL API running under `/.api/graphql`
 *
...
/**
 * Does a GraphQL query to the Nxpkg GraphQL API running under `/.api/graphql`
 *
...
/**
 * Does a GraphQL mutation to the Nxpkg GraphQL API running under `/.api/graphql`
 *
