...
import { Location } from 'nxpkg/module/protocol/plainTypes'
...
export interface XReferenceOptions extends WorkspaceReferenceParams {
     ...
     * https://github.com/nxpkg/go-langserver/blob/885ad3639de0e1e6c230db5395ea0f682534b458/pkg/lspext/lspext.go#L32
     */
    limit: number
}
