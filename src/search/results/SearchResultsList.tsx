                                        ...
                                        (results.timedout.length > 0 ? (
                                            ...
                                            <div className="alert alert-warning">
                                                ...
                                                {this.renderRecommendations([
                                                    ...
                                                    /* If running Nxpkg Server, give some smart advice */
                                                    ...(!window.context.nxpkgDotComMode &&
                                                        !window.context.isRunningDataCenter
                                                        ? [
                                                            <>
                                                                Upgrade to Nxpkg Data Center for distributed
                                                            ...
                                                            window.context.likelyDockerOnMac
                                                                ...
                                                                : 'Run Nxpkg on a server with more CPU and memory, or faster disk IO',
                                                        ]
                                                        : []),
                                                ])}
                                            </div>
