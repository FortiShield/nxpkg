...
export class SavedQueries extends React.Component<Props, State> {
    public state: State = {
        ...
        loading: true,
        user: null,
        isViewingExamples: window.context.nxpkgDotComMode
            ? false
        ...
        this.subscriptions.add(
            siteFlags
                ...
                .subscribe(disableBuiltInSearches => {
                    this.setState({
                        // TODO: Remove the need to check nxpkgDotComMode by adding this to config
                        disableBuiltInSearches: window.context.nxpkgDotComMode || disableBuiltInSearches,
                    })
                })
        )
                    ...
                    <div>
                        <div className="saved-queries__header">
                            ...
                            <div className="saved-queries__actions">
                                ...
                                <a
                                    href="https://about.nxpkg.com/docs/search/saved-searches"
