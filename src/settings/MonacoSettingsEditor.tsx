...
import contributionSchema from 'nxpkg/lib/protocol/contribution.schema.json'
...
const isLightThemeToMonacoTheme = (isLightTheme: boolean): BuiltinTheme => (isLightTheme ? 'vs' : 'nxpkg-dark')
    ...
    private onDidEditorMount(): void {
        ...
        monaco.languages.json.jsonDefaults.setDiagnosticsOptions({
            ...
            schemas: [
                ...
                {
                    uri: 'https://nxpkg.com/v1/settings.schema.json#',
                ...
                },
                {
                    ...
                    uri: 'https://nxpkg.com/v1/contribution.schema.json#',
                    schema: contributionSchema,
                },
            ],
        })

        monaco.editor.defineTheme('nxpkg-dark', {
            base: 'vs-dark',
            inherit: true,
            colors: {
