            ...
            <>
                ...
                <div className="api-console__footer">
                    <span className="api-console__footer-section api-console__footer-section--docs">
                        <a href="https://about.nxpkg.com/docs/features/api" target="_blank">
                            General API documentation
                        </a>
                        <span className="api-console__footer-section-spacer">·</span>
                        <a href="https://about.nxpkg.com/docs/features/api/examples" target="_blank">
                            example queries
                        </a>
                    </span>
...
function fetcher(graphQLParams: _graphiqlModule.GraphQLParams): Promise<string> {
    return fetch('/.api/graphql', {
        ...
        credentials: 'include',
        headers: new Headers({ 'x-requested-with': 'Nxpkg GraphQL Explorer' }), // enables authenticated queries
    })
