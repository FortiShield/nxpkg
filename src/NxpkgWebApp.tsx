...
import { EMPTY_ENVIRONMENT as EXTENSIONS_EMPTY_ENVIRONMENT } from 'nxpkg/module/client/environment'
...
export interface NxpkgWebAppProps {
 ...
 * The root component
 */
export class NxpkgWebApp extends React.Component<NxpkgWebAppProps, NxpkgWebAppState> {
    constructor(props: NxpkgWebAppProps) {
        super(props)
    ...
    public componentDidMount(): void {
        ...
        // Keep the Nxpkg extensions controller's extensions up-to-date.
        //
    ...
    private onConfigurationCascadeChange(
        ...
        this.setState(
            prevState => {
                const update: Pick<NxpkgWebAppState, 'configurationCascade' | 'extensionsEnvironment'> = {
                ...
                if (
                    ...
                    // Only update Nxpkg extensions environment configuration if the configuration was
                    // successfully parsed.
                    //
