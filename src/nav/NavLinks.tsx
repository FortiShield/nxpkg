...
export class NavLinks extends React.PureComponent<Props> {
    ...
    private onClickInstall = (): void => {
        eventLogger.log('InstallNxpkgServerCTAClicked', {
            ...
            <ul className="nav-links nav align-items-center pl-2 pr-1">
                {showDotComMarketing && (
                    <li className="nav-item">
                        <a
                            href="https://about.nxpkg.com"
                            className="nav-link text-truncate"
                            onClick={this.onClickInstall}
                            title="Install self-hosted Nxpkg to search your own code"
                        >
                            Install <span className="nav-links__widescreen-only">Nxpkg</span>
                        </a>
                    </li>
                )}
                <ActionsNavItems
                ...
                {showDotComMarketing && (
                    <li className="nav-item">
                        <a href="https://about.nxpkg.com" className="nav-link">
                            About
                        </a>
                    </li>
                )}
