...
pre-migration versions of Nxpkg. This is because frontend pods are updated in a rolling
...
- Roll back Nxpkg to the previous version. On startup, the frontend pods will log a migration
...
- Determine the two commits that correspond to the previous and new versions of Nxpkg. Check
