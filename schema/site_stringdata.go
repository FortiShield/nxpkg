...
const SiteSchemaJSON = `{
  ...
  "properties": {
    ...
    "experimentalFeatures": {
      ...
      "properties": {
        ...
        "canonicalURLRedirect": {
          "description":
            "Enables or disables redirecting to the canonical URL (underneath the \"appURL\") for incoming HTTP requests. This experiment is intended to be enabled for all instances as of Nxpkg 2.9.",
          "type": "string",
          "enum": ["enabled", "disabled"],
          "default": "disabled"
        },
    ...
    "httpStrictTransportSecurity": {
      "description": "The value of the HTTP Strict-Transport-Security (HSTS) header sent by Nxpkg, if non-empty",
    ...
    "git.cloneURLToRepositoryName": {
      "description":
        "JSON array of configuration that maps from Git clone URL to repository URI. Nxpkg automatically resolves remote clone URLs to their proper code host. However, there may be non-remote clone URLs (e.g., in submodule declarations) that Nxpkg cannot automatically map to a code host. In this case, use this field to specify the mapping. The mappings are tried in the order they are specified and take precedence over automatic mappings.",
      "type": "array",
      "items": {
    ...
    "licenseKey": {
      "description":
        "The Nxpkg license key, which enables premium Nxpkg features. To obtain this value, contact Nxpkg to purchase a license.",
      "type": "string"
    },
    "maxReposToSearch": {
      "description":
    ...
    "parentNxpkg": {
      "description": "URL to fetch unreachable repository details from. Defaults to \"https://nxpkg.com\"",
      "type": "object",
      "additionalProperties": false,
      "properties": {
        "url": {
    ...
    "auth.accessTokens": {
      "description":
        "Settings for access tokens, which enable external tools to access the Nxpkg API with the privileges of the user.",
      "type": "object",
      "additionalProperties": false,
      "properties": {
        "allow": {
    ...
    "extensions": {
      "description": "Configures Nxpkg extensions.",
      "type": "object",
      "properties": {
        "disabled": {
    ...
    "discussions": {
      "description": "Configures Nxpkg code discussions.",
      "type": "object",
      "properties": {
        "abuseProtection": {
          "description":
            "Enable abuse protection features (for public instances like Nxpkg.com, not recommended for private instances).",
          "type": "boolean",
          "default": false
        },
        "abuseEmails": {
    ...
    "settings": {
      ...
      "description":
        "Site settings hard-coded in site configuration.\n\nDEPRECATED: Specify site settings in the site admin global settings page instead of hard-coding them in the site configuration file. This makes it possible to change site settings without redeploying the cluster in Nxpkg Data Center.",
      "type": "object",
      "properties": {
    ...
    "BitbucketServerConnection": {
      ...
      "properties": {
        ...
        "excludePersonalRepositories": {
          "description":
            "Whether or not personal repositories should be excluded or not. When true, Nxpkg will ignore personal repositories it may have access to. See https://about.nxpkg.com/docs/config/repositories/#excluding-personal-repositories for more information. Default: false.",
          "type": "boolean"
        },
        "initialRepositoryEnablement": {
          "description":
    ...
    "SAMLAuthProvider": {
      ...
      "properties": {
        ...
        "serviceProviderIssuer": {
          "description":
            "The name of this SAML Service Provider, which is used by the Identity Provider to identify this Service Provider. It defaults to https://nxpkg.example.com/.auth/saml/metadata (where https://nxpkg.example.com is replaced with this Nxpkg instance's \"appURL\"). It is only necessary to explicitly set the issuer if you are using multiple SAML authentication providers.",
          "type": "string"
        },
