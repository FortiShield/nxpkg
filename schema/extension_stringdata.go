...
const ExtensionSchemaJSON = `{
  ...
  "$id": "https://nxpkg.com/v1/extension.schema.json#",
  "title": "Nxpkg extension manifest",
  "description": "The Nxpkg extension manifest describes the extension and the features it provides.",
  "type": "object",
  ...
  "definitions": {
    "Contributions": {
      ...
      "properties": {
        "configuration": {
          "description":
            "The JSON Schema for the configuration settings used by this extension. This schema is merged with the Nxpkg settings schema. The final schema for settings is the union of Nxpkg settings and all added extensions' settings.",
