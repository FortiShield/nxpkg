...
// AuthAccessTokens description: Settings for access tokens, which enable external tools to access the Nxpkg API with the privileges of the user.
...
// Discussions description: Configures Nxpkg code discussions.
...
// Extensions description: Configures Nxpkg extensions.
...
// ParentNxpkg description: URL to fetch unreachable repository details from. Defaults to "https://nxpkg.com"
type ParentNxpkg struct {
	Url string `json:"url,omitempty"`
}
...
// Settings description: Configuration settings for users and organizations on Nxpkg.
...
// SiteConfiguration description: Configuration for a Nxpkg site.
type SiteConfiguration struct {
	...
	ParentNxpkg                 *ParentNxpkg           `json:"parentNxpkg,omitempty"`
...
// NxpkgExtensionManifest description: The Nxpkg extension manifest describes the extension and the features it provides.
type NxpkgExtensionManifest struct {
