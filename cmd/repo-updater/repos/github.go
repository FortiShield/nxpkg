...
import (
	...
	"github.com/nxpkg/nxpkg/cmd/repo-updater/internal/externalservice/github"
...
func GetGitHubRepository(ctx context.Context, args protocol.RepoLookupArgs) (repo *protocol.RepoInfo, authoritative bool, err error) {
	...
	if bypass {
		...
		if isPublicRepo {
			...
			// exist (like github.com/settings/profile) or that are private and not on Nxpkg.com.
...
// updateGitHubRepositories ensures that all provided repositories have been added and updated on Nxpkg.
