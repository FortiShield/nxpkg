...
parser = argparse.ArgumentParser(
    description='Text search remote repositories with Nxpkg',
...
parser.add_argument(
    ...
    nargs='+',
    help=
    'repo or org to search. eg github.com/nxpkg or github.com/golang/go')
parser.add_argument(
...
parser.add_argument(
    ...
    '--url',
    action='store_true',
    help='Print matches as URLs to nxpkg.com')

other = parser.add_argument_group()
other.add_argument(
    '--domain',
    type=str,
    default='https://nxpkg.com',
    help='API host to use. Defaults to https://nxpkg.com')
other.add_argument(
    '--file-match-limit',
    type=int,
    default=10000,
