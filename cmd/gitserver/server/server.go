...
import (
	...
	"github.com/nxpkg/nxpkg/pkg/honey"
	"github.com/nxpkg/nxpkg/pkg/mutablelimiter"
	"github.com/nxpkg/nxpkg/pkg/repotrackutil"
...
func (s *Server) handleExec(w http.ResponseWriter, r *http.Request) {
	...
	if strings.ToLower(string(req.Repo)) == "github.com/nxpkgtest/alwayscloningtest" {
...
func setGitAttributes(gitDir string) error {
	...
	_, err := updateFileIfDifferent(
		...
		[]byte(`# Managed by Nxpkg gitserver.
...
func (s *Server) isCloneable(ctx context.Context, url string) error {
	...
	if strings.ToLower(string(protocol.NormalizeRepo(api.RepoURI(url)))) == "github.com/nxpkgtest/alwayscloningtest" {
		return nil
	}
