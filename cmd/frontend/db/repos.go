...
// List lists repositories in the Nxpkg repository
//
// This will not return any repositories from external services that are not present in the Nxpkg repository.
