...
type DotcomMutationResolver interface {
	GenerateNxpkgLicenseKey(ctx context.Context, args *DotcomMutationGenerateNxpkgLicenseKeyArgs) (string, error)
}

type DotcomMutationGenerateNxpkgLicenseKeyArgs struct {
	Plan         string
	MaxUserCount *int32
	ExpiresAt    *int32
}
