...
import (
	...
	"github.com/nxpkg/nxpkg/pkg/inventory/filelang"
	...
	searchquerytypes "github.com/nxpkg/nxpkg/cmd/frontend/internal/pkg/search/query/types"
	"github.com/nxpkg/nxpkg/cmd/frontend/types"
	"github.com/nxpkg/nxpkg/pkg/conf"
	"github.com/nxpkg/nxpkg/pkg/pathmatch"
...
func getSampleRepos(ctx context.Context) ([]*types.Repo, error) {
	...
	if sampleRepos == nil {
		sampleRepoPaths := []api.RepoURI{
			...
			"github.com/nxpkg/javascript-typescript-langserver",
