...
func TestIsBinary(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			// https://nxpkg.com/github.com/golang/go@a4330ed694c588d495f7c72a9cbb0cd39dde31e8/-/blob/src/net/http/sniff_test.go#L45
			input: []byte("RIFFb\xb8\x00\x00WAVEfmt \x12\x00\x00\x00\x06"),
			want:  true,
		},
		{
			name: "binary MP4 video",
			// https://nxpkg.com/github.com/golang/go@a4330ed694c588d495f7c72a9cbb0cd39dde31e8/-/blob/src/net/http/sniff_test.go#L55
