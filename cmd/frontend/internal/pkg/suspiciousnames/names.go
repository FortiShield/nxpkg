...
// organization name is suspicious and the currently running site is Nxpkg.com.
//
// It is intended to prevent users/organizations on Nxpkg.com from changing their name to a
...
func CheckNameAllowedForUserOrOrganization(desiredName string) error {
	if envvar.NxpkgDotComMode() && isSuspicious(desiredName) {
