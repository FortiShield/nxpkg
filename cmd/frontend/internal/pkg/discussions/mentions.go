...
import (
	...
	"github.com/nxpkg/nxpkg/cmd/frontend/internal/pkg/markdown"
...
{{- "—\n" -}}
{{- if .CanReply -}}
	{{- "Reply to this email directly, or view it on Nxpkg:\n" -}}
{{- else -}}
...
<script type="application/ld+json">
{
	...
	"description": "View this discussion on Nxpkg"
}
</script>
...
{{end}}
{{if .CanReply}}
	<p style="font-size: small; color: #666;">—<br/>Reply to this email directly or <a href="{{.URL}}">view it on Nxpkg</a>.</p>
{{else}}
	<p style="font-size: small; color: #666;">—<br/><a href="{{.URL}}">View and reply on Nxpkg</a></p>
{{end}}
