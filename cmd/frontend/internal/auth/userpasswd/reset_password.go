...
var (
	resetPasswordEmailTemplates = txemail.MustValidate(txemail.Templates{
		Subject: `Reset your Nxpkg password`,
		Text: `
Somebody (likely you) requested a password reset for the user {{.Username}} on Nxpkg.

To reset the password for {{.Username}} on Nxpkg, follow this link:
