...
import (
	...
	"github.com/nxpkg/nxpkg/cmd/frontend/internal/app/pkg/updatecheck"
	"github.com/nxpkg/nxpkg/cmd/frontend/internal/bg"
	"github.com/nxpkg/nxpkg/cmd/frontend/internal/cli/loghandlers"
	"github.com/nxpkg/nxpkg/cmd/frontend/internal/goroutine"
	"github.com/nxpkg/nxpkg/cmd/frontend/internal/pkg/discussions/mailreply"
	...
	"github.com/nxpkg/nxpkg/pkg/debugserver"
	"github.com/nxpkg/nxpkg/pkg/env"
	"github.com/nxpkg/nxpkg/pkg/processrestart"
	"github.com/nxpkg/nxpkg/pkg/sysreq"
	"github.com/nxpkg/nxpkg/pkg/tracer"
...
var (
	...
	printLogo, _ = strconv.ParseBool(env.Get("LOGO", "false", "print Nxpkg logo upon startup"))
...
func Main() error {
	...
	fmt.Printf("✱ Nxpkg is ready at: %s\n", appURL)
