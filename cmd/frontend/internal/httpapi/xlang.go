...
import (
	...
	"github.com/nxpkg/nxpkg/cmd/frontend/httpapi"
	"github.com/nxpkg/nxpkg/pkg/actor"
	"github.com/nxpkg/nxpkg/pkg/errcode"
	"github.com/nxpkg/nxpkg/pkg/honey"
	xlang_lspext "github.com/nxpkg/nxpkg/xlang/lspext"
	"github.com/nxpkg/nxpkg/xlang/uri"
)
...
func serveXLang(w http.ResponseWriter, r *http.Request) (err error) {
	...
	defer func() {
		...
		// diving. https://github.com/nxpkg/nxpkg/issues/2362
		isUserError := false
		...
		if honey.Enabled() {
			...
			ev.AddField("client", r.Header.Get("x-nxpkg-client"))
