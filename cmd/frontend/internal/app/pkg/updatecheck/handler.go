...
import (
	...
	"github.com/nxpkg/nxpkg/pkg/hubspot"

	"github.com/nxpkg/nxpkg/cmd/frontend/internal/app/tracking"

	"github.com/nxpkg/nxpkg/pkg/conf"
	"github.com/nxpkg/nxpkg/pkg/eventlogger"
...
var (
	// latestReleaseServerBuild is only used by nxpkg.com to tell existing
	// Server installations what the latest version is. The version here _must_ be
	// available at https://hub.docker.com/r/nxpkg/server/tags/ before
	// landing in master.
	latestReleaseServerBuild = newBuild("2.11.0")

	// latestReleaseDataCenterBuild is only used by nxpkg.com to tell existing
	// Data Center installations what the latest version is. The version here _must_ be
	// available at https://storage.googleapis.com/nxpkg-assets/nxpkg-server-gen/
