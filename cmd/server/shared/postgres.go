...
func maybePostgresProcFile() (string, error) {
	...
	if _, err := os.Stat(path); err != nil {
		...
		log.Println("✱ Nxpkg is initializing the internal database... (may take 15-20 seconds)")
		...
		e.Command("su-exec", "postgres", "createdb", "nxpkg")
	...
	// (see https://github.com/nxpkg/issues/issues/34 and https://github.com/nxpkg/nxpkg/issues/9129).
	SetDefaultEnv("PGHOST", "127.0.0.1")
	SetDefaultEnv("PGUSER", "postgres")
	SetDefaultEnv("PGDATABASE", "nxpkg")
