...
//docker:install curl
//docker:run curl -o /usr/local/bin/syntect_server https://storage.googleapis.com/nxpkg-artifacts/syntect_server/3cab2cade05c0f18190ac34c565bbd40 && chmod +x /usr/local/bin/syntect_server
