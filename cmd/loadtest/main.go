...
var (
	FrontendHost     = env.Get("LOAD_TEST_FRONTEND_URL", "http://nxpkg-frontend-internal", "URL to the Nxpkg frontend host to load test")
	FrontendPort     = env.Get("loadTestFrontendPort", "80", "Port that the Nxpkg frontend is listening on")
