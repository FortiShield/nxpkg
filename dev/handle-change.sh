...
$generate_graphql && { go generate github.com/nxpkg/nxpkg/cmd/frontend/graphqlbackend || failed=true; }
$generate_schema && { go generate github.com/nxpkg/nxpkg/schema || failed=true; }
if $all_cmds; then
