...
// 	github.com/nxpkg/nxpkg/xlang/lspx
//
package lspext
...
type DependencyReference struct {
	...
	// Hints is treated as an opaque object and passed directly by Nxpkg
	...
	//
	// If a language server emits no hints, Nxpkg will pass none as a
