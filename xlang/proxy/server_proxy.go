...
import (
	...
	plspext "github.com/nxpkg/go-langserver/pkg/lspext"
...
func (c *serverProxyConn) lspInitialize(ctx context.Context) (*lsp.InitializeResult, error) {
	...
	// to keep the connection alive: https://github.com/nxpkg/nxpkg/issues/11657
	...
	initParams := lspext.InitializeParams{
		InitializeParams: lsp.InitializeParams{
			...
			// NOTE: These may not accurately represent the end client's (e.g., the Nxpkg
